...
<body>
    <div class="container-background">
        ...
        if (!empty($image)) : ?>
        <img class="background-image" src="<?php echo esc_url($image['url']); ?>"
            alt="<?php echo esc_attr($image['alt']); ?>" />
        <?php endif; ?>
    ...
    <div class="services">
        <div class="services-container">
            <div class="services-item">
                ...
                if (!empty($image)) : ?>
                <img var(--color-text-green); src="<?php echo esc_url($image['url']); ?>"
                    alt="<?php echo esc_attr($image['alt']); ?>" />
                <?php endif; ?>
                    ...
                    <div class="services-grid-img">
                        ...
                        <div class="services-grid-hover">
                            ...
                            <a class="button button-pink"
                                href="<?php echo get_home_url() . the_field("service-grid{$i}-title"); ?>">Voir nos
                                soins
